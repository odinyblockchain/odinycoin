...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/odinycoin-cli.cpp \
           src/odinycoin-tx.cpp \
           src/odinycoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/odinycoin.qrc src/qt/odinycoin_locale.qrc

TRANSLATIONS += src/qt/locale/odinycoin_bg.ts \
                src/qt/locale/odinycoin_de.ts \
                src/qt/locale/odinycoin_en.ts \
                src/qt/locale/odinycoin_es.ts \
                src/qt/locale/odinycoin_fi.ts \
                src/qt/locale/odinycoin_fr.ts \
                src/qt/locale/odinycoin_it.ts \
                src/qt/locale/odinycoin_ja.ts \
                src/qt/locale/odinycoin_pl.ts \
                src/qt/locale/odinycoin_pt.ts \
                src/qt/locale/odinycoin_ru.ts \
                src/qt/locale/odinycoin_sk.ts \
                src/qt/locale/odinycoin_sv.ts \
                src/qt/locale/odinycoin_vi.ts \
                src/qt/locale/odinycoin_zh_CN.ts \
                src/qt/locale/odinycoin_zh_TW.ts
