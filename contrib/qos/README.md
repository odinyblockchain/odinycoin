...
This means one can have an always-on odinycoind instance running, and another local odinycoind/odinycoin-qt instance which connects to this node and receives blocks from it.
