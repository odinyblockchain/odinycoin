 ...
 * Odinycoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int OdinycoinBadBlockTime() const { return nOdinycoinBadBlockTime; }
    int OdinycoinBadBlocknBits() const { return nOdinycoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nOdinycoinBadBlockTime;
    unsigned int nOdinycoinBadBlocknBits;
