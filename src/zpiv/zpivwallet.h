// Copyright (c) 2017-2018 The Odinycoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Odinycoin_ZODCWALLET_H
#define Odinycoin_ZODCWALLET_H
...
public:
    CzODCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZODC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZODC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
