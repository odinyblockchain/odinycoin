...
#ifndef Odinycoin_ZODCTRACKER_H
#define Odinycoin_ZODCTRACKER_H
...
public:
    CzODCTracker(std::string strWalletFile);
    ~CzODCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzODCWallet* zODCWallet = NULL);
