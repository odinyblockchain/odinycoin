                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzODCPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzODCPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzODCPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzODCPathCustom.empty()) && nCustomBackupThreshold > 0) {
