...
#ifndef Odinycoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Odinycoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Odinycoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
