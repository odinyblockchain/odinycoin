...
#include "qt/odinycoin/forms/ui_addresseswidget.h"
#include "qt/odinycoin/addresslabelrow.h"
#include "qt/odinycoin/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(OdinycoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Odinycoin address"));
