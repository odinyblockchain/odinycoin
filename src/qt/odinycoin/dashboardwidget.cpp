...
#include "qt/odinycoin/forms/ui_dashboardwidget.h"
#include "qt/odinycoin/sendconfirmdialog.h"
#include "qt/odinycoin/txrow.h"
...
DashboardWidget::DashboardWidget(OdinycoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of ODC staked."));
    ...
    ui->labelAmountPiv->setText("0 ODC");
    ...
    ui->btnHowTo->setText(tr("How to get ODC"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("ODC")
    updateDisplayUnit();
}
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZODC;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair ODC, zODC
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("ODC");
    set1 = new QBarSet("zODC");
    set0->setColor(QColor(62,119,193));
