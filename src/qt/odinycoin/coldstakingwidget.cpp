...
#include "qt/odinycoin/coldstakingwidget.h"
#include "qt/odinycoin/forms/ui_coldstakingwidget.h"
#include "qt/odinycoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/odinycoin/requestdialog.h"
#include "qt/odinycoin/tooltipmenu.h"
#include "qt/odinycoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(OdinycoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your ODCs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept ODC delegation / Delegate ODC"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select ODC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 ODC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
