...
#include "qt/odinycoin/forms/ui_receivewidget.h"
...
#include "qt/odinycoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(OdinycoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive ODC."));
