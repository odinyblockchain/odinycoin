...
#include "qt/odinycoin/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/odinycoin/lockunlock.h"
#include "qt/odinycoin/qtutils.h"
#include "qt/odinycoin/receivedialog.h"
...
TopBar::TopBar(OdinycoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("Odinycoin")
    updateDisplayUnit();
