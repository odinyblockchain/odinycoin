...
#include "qt/odinycoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(OdinycoinGUI* _window, QWidget *parent) :
