...
#include "qt/odinycoin/settings/settingsnetworkwidget.h"
#include "qt/odinycoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/odinycoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OdinycoinGUI* _window, QWidget *parent) :
