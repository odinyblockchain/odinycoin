...
#include "qt/odinycoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/odinycoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(OdinycoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to OdinycoinGUI::handleRestart()
