...
#include "qt/odinycoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/odinycoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(OdinycoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the Odinycoin RPC console.") + "<br>" +
