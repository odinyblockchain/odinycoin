...
#include "qt/odinycoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/odinycoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(OdinycoinGUI* _window, QWidget *parent) :
