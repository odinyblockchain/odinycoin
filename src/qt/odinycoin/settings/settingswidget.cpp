...
#include "qt/odinycoin/settings/forms/ui_settingswidget.h"
#include "qt/odinycoin/settings/settingsbackupwallet.h"
#include "qt/odinycoin/settings/settingsbittoolwidget.h"
#include "qt/odinycoin/settings/settingswalletrepairwidget.h"
#include "qt/odinycoin/settings/settingswalletoptionswidget.h"
#include "qt/odinycoin/settings/settingsmainoptionswidget.h"
#include "qt/odinycoin/settings/settingsdisplayoptionswidget.h"
#include "qt/odinycoin/settings/settingsmultisendwidget.h"
#include "qt/odinycoin/settings/settingsinformationwidget.h"
#include "qt/odinycoin/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(OdinycoinGUI* parent) :
    PWidget(parent),
