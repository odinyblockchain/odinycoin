...
#include "qt/odinycoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(OdinycoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-odinycoin");
