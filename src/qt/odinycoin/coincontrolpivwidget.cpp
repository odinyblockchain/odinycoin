...
#include "qt/odinycoin/coincontrolpivwidget.h"
#include "qt/odinycoin/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select ODC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ODC");
    ...
    ui->labelValueAfter->setText("0.00 ODC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ODC");
    ui->labelValueFee->setText("0.00 ODC");
