...
#include "qt/odinycoin/furabstractlistitemdelegate.h"
#include "qt/odinycoin/txviewholder.h"
#include "qt/odinycoin/tooltipmenu.h"
#include "qt/odinycoin/sendmultirow.h"
#include "qt/odinycoin/coldstakingmodel.h"
#include "qt/odinycoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(OdinycoinGUI* parent);
    ~ColdStakingWidget();
