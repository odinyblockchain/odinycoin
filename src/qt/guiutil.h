...
/** Utility functions used by the Odinycoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Odinycoin addresses in monospace font
...
// Parse "odinycoin:" URI into recipient object, return true on successful parsing
