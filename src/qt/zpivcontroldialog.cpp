// Copyright (c) 2017-2020 The Odinycoin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zODC Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zODC.";
            else if (!mint.isSeedCorrect)
                strReason = "The zODC seed used to mint this zODC is not the same as currently hold in the wallet";
            else
