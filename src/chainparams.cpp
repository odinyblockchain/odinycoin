...
// Copyright (c) 2015-2019 The Odinycoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000af3d7dca69d0eb5063fc1656c41bdbd2206211d05f41abda7a588636b69"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 1517;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Odinycoin starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 400;
        nOdinycoinBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nOdinycoinBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
        ...
        nBIP65ActivationHeight = 403;
        // Activation height for TimeProtocolV2, Blocks V7 and newMessageSignatures
        nBlockTimeProtocolV2 = 430;
        ...
        // Blocks v7
        nBlockLastAccumulatorCheckpoint = 402;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "The rail-line was carried under the Tsugaru Strait to Hokkaido.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1600101505;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2037502;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("00000af3d7dca69d0eb5063fc1656c41bdbd2206211d05f41abda7a588636b69"));
        assert(genesis.hashMerkleRoot == uint256("4f5cb6e6b7f54ecc566f98b66a96d0cce2c416daf390e291573747ff03a9166c"));

        vSeeds.push_back(CDNSSeedData("140.82.13.75", "140.82.13.75"));
        vSeeds.push_back(CDNSSeedData("207.246.83.28", "207.246.83.28"));
        vSeeds.push_back(CDNSSeedData("45.77.151.115", "45.77.151.115"));
        vSeeds.push_back(CDNSSeedData("149.28.231.51", "149.28.231.51"));
        ...
        strSporkPubKey = "04018a5e3998235d1c4e17c49a95d6617baa8f550c212fc887ed028665500bb30ab8f9010ed62ab2d35e2adf1004e2154e0b2a4babc6b73f6e843b7653e0368fed";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nOdinycoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nOdinycoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "odinycoin-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "odinycoin-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.odinycoin.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet odinycoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet odinycoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet odinycoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet odinycoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet odinycoin BIP44 coin type is '1' (All coin's testnet default)
