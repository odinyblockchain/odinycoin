...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Odinycoin Core odinycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  odinycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded odinycoin transaction") + "\n" +
                               "  odinycoin-tx [options] -create [commands]   " + _("Create hex-encoded odinycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded odinycoin transaction
