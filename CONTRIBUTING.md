Contributing to Odinycoin Core
============================

The Odinycoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/odinycoin-project/odinycoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Odinycoin Core project, and is not to be
confused with overall Odinycoin Network Protocol consensus changes.

Whether a pull request is merged into Odinycoin Core rests with the project merge
...
Patches that change Odinycoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Odinycoin consensus, it must have been
...
The project leader is the release manager for each Odinycoin Core release.
