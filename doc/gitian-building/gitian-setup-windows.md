...
The build script we'll be using is contained in the Odinycoin github repository ([contrib/gitian-build.py](https://github.com/odinycoin-project/odinycoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Odinycoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Odinycoin-Project/Odinycoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, odinycoin-detached-sigs, and odinycoin GitHub repos.
