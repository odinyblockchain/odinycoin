...
The script [extract-osx-sdk.sh](https://github.com/odinycoin-project/odinycoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
odinycoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/odinycoin-project/odinycoin/blob/master/doc/README_osx.md) for troubleshooting tips.