...
class RawTransactionsTest(OdinycoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid odinycoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid odinycoin address" in e.error['message'])
