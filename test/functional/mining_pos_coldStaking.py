...
from test_framework.odinycoin_node import OdinycoinTestNode
...
class Odinycoin_ColdStakingTest(OdinycoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(OdinycoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 ODC from the pot)
...
if __name__ == '__main__':
    Odinycoin_ColdStakingTest().main()
