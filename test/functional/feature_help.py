...
"""Verify that starting odinycoin with -h works as expected."""
import subprocess

from test_framework.test_framework import OdinycoinTestFramework
from test_framework.util import assert_equal

class HelpTest(OdinycoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start odinycoin with -h for help text")
        ...
        self.log.info("Start odinycoin with -version for version information")
